...
const CmsBlogArticle = () => {
  ...
  // Build related articles (same category first, then recent)
  ...
  const processContent = (html: string) => {
    ...
    // Convert CTA blocks to styled buttons
  ...
  return (
    <PageLayout>
      ...
      {/* Hero image - same as static articles */}
        ...
        <section className="border-t border-border bg-secondary/30 py-16">
          <div className="container">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {related.map((r) => (
                <Link key={r.slug} to={`/blog/cms/${r.slug}`} className="group block">
