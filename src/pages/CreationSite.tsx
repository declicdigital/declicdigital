...
const CreationSite = () => (
  <PageLayout>
      ...
      <div className="container">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={i} className="rounded-2xl p-6 shadow-card text-center" style={{ backgroundColor: "#F6F1E9" }}>
      ...
      <div className="container">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={i} className="rounded-2xl p-6 shadow-card" style={{ backgroundColor: "#E9F2F4" }}>
      ...
      <div className="container">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={i} className="flex items-start gap-4 rounded-xl p-5 shadow-card" style={{ backgroundColor: "#F6F1E9" }}>
    ...
    {/* ─── Image développeur — bloc 5 → #F6F1E9 ───────────────────────────── */}
      ...
      <div className="container">
        <div className="relative">
          <div className="hidden lg:block absolute left-0 top-0 h-full w-5/12 rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0" style={{ background: "linear-gradient(to left, #F6F1E9 0%, rgba(246,241,233,0.4) 30%, transparent 65%)" }} />
          </div>
    ...
    {/* ─── Contenu SEO texte — bloc 6 → #E9F2F4 ───────────────────────────── */}
    <section className="py-12 md:py-16" style={{ backgroundColor: "#E9F2F4" }}>
      <div className="container">
      ...
      <div className="container">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {cities.slice(0, 12).map((c) => (
            <Link key={c.slug} to={`/creation-site-web/${c.slug}`} className="rounded-full border px-4 py-2 text-sm font-medium transition-colors" style={{ backgroundColor: "#F6F1E9", color: "#2B1E3F", borderColor: "#2B1E3F" }}>
              Site web {c.nameShort}
            </Link>
          ))}
          <Link to="/nos-villes" className="rounded-full px-4 py-2 text-sm font-semibold btn-glow" style={{ backgroundColor: "#E9F2F4", color: "#2B1E3F" }}>
    ...
    <section className="relative overflow-hidden py-16" data-alternate="skip">
      ...
      <div className="container relative z-10 flex flex-col items-center text-center">
        <img src={geoffreyPhoto} alt="Geoffrey, fondateur de Déclic Digital et Expert Produit Google" className="w-16 h-16 rounded-full object-cover border-2 shadow-lg mb-3" style={{ borderColor: "rgba(43,30,63,0.3)" }} loading="lazy" />
