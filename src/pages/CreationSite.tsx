...
const CreationSite = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* ─── Avantages — bloc 1 → #F6F1E9 ───────────────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#F6F1E9" }}>
        <div className="container">
          <h2 className="text-center mb-4" style={{ color: "#2B1E3F" }}>Pourquoi votre activité a besoin d'un site web professionnel</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={i} className="rounded-2xl p-6 text-center" style={{ backgroundColor: "#E9F2F4", boxShadow: "0 4px 24px -4px rgba(43,30,63,0.08)" }}>
      ...
      {/* ─── Processus — bloc 2 → #E9F2F4 ───────────────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#E9F2F4" }}>
        <div className="container">
          <h2 className="text-center mb-4" style={{ color: "#2B1E3F" }}>Un site vitrine ou e-commerce adapté à votre métier</h2>
          <p className="text-center max-w-2xl mx-auto mb-10" style={{ color: "#2B1E3F", opacity: 0.7 }}>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={i} className="rounded-2xl p-6" style={{ backgroundColor: "#F6F1E9", boxShadow: "0 4px 24px -4px rgba(43,30,63,0.08)" }}>
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg gradient-primary" style={{ color: "#2B1E3F" }}>
                  <item.icon size={22} />
                </div>
                <h3 className="mb-2 font-bold" style={{ color: "#2B1E3F" }}>{item.title}</h3>
                <p className="text-sm" style={{ color: "#2B1E3F", opacity: 0.7 }}>{item.desc}</p>
      ...
      {/* ─── Pour qui — bloc 3 → #F6F1E9 ────────────────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#F6F1E9" }}>
        <div className="container">
          <h2 className="text-center mb-4" style={{ color: "#2B1E3F" }}>Notre méthode : de la maquette à la mise en ligne</h2>
          <p className="text-center max-w-2xl mx-auto mb-10" style={{ color: "#2B1E3F", opacity: 0.7 }}>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 rounded-xl p-5" style={{ backgroundColor: "#E9F2F4", boxShadow: "0 4px 24px -4px rgba(43,30,63,0.08)" }}>
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg gradient-primary" style={{ color: "#2B1E3F" }}>
                  <item.icon size={22} />
                </div>
                <div>
                  <h3 className="font-bold" style={{ color: "#2B1E3F" }}>{item.title}</h3>
                  <p className="text-sm" style={{ color: "#2B1E3F", opacity: 0.7 }}>{item.desc}</p>
                </div>
              </div>
            ))}
      ...
      {/* ─── Image développeur — bloc 4 → #E9F2F4 ───────────────────────────── */}
        ...
        <div className="container">
          <div className="relative">
            ...
            <div className="relative z-10 ml-auto max-w-2xl space-y-6 py-8">
              <h2 style={{ color: "#2B1E3F" }}>Site web rapide, mobile et optimisé pour Google</h2>
              ...
              <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                ...
                <Link to="/referencement-seo" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>optimisation SEO complète</Link>,
      ...
      {/* ─── Contenu SEO texte — bloc 5 → #F6F1E9 ───────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#F6F1E9" }}>
        <div className="container">
          <div className="mx-auto max-w-3xl space-y-6">
            <h2 className="text-center" style={{ color: "#2B1E3F" }}>Création de site web pour artisan à Paris : pourquoi c'est indispensable</h2>
            <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
            ...
            <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
              Nous utilisons les technologies les plus adaptées selon votre projet : WordPress pour les sites éditoriaux, Shopify pour le e-commerce, ou des solutions sur-mesure pour les besoins spécifiques. Quel que soit l'outil, nous garantissons un site rapide (score PageSpeed supérieur à 90), sécurisé (HTTPS), et conforme aux standards d'accessibilité. Consultez nos{" "}
              <Link to="/realisations" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>réalisations récentes</Link>{" "}
              pour voir des exemples concrets.
            </p>
            <h3 style={{ color: "#2B1E3F" }}>Combien coûte la création d'un site internet pour une TPE ?</h3>
            <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
              Chez Déclic Digital, nous proposons des{" "}
              <Link to="/tarifs" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>tarifs adaptés aux budgets des TPE</Link> :
              une landing page dès 200€ de mise en service + 50€/mois, un site vitrine complet dès 590€ + 50€/mois. Ces forfaits incluent le design, le développement, l'hébergement, la maintenance et l'optimisation SEO de base. Vous avez une question ? Consultez{" "}
              <Link to="/faq" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>notre FAQ</Link>{" "}
              ou{" "}
              <Link to="/rendez-vous" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>prenez rendez-vous</Link>.
            </p>
          </div>
        </div>
      </section>

      {/* ─── Villes — bloc 6 → #E9F2F4 ──────────────────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#E9F2F4" }}>
        <div className="container">
          <h2 className="text-center mb-6" style={{ color: "#2B1E3F" }}>Création de site internet à Paris et dans les Hauts-de-Seine</h2>
          <p className="text-center mb-8" style={{ color: "#2B1E3F", opacity: 0.7 }}>
            Nous intervenons à Paris et dans les Hauts-de-Seine pour la{" "}
            <Link to="/nos-villes" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>création de sites web professionnels</Link>.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {cities.slice(0, 12).map((c) => (
              <Link key={c.slug} to={`/creation-site-web/${c.slug}`} className="rounded-full border px-4 py-2 text-sm font-medium transition-colors" style={{ backgroundColor: "#F6F1E9", color: "#2B1E3F", borderColor: "rgba(43,30,63,0.25)" }}>
                Site web {c.nameShort}
              </Link>
            ))}
            <Link to="/nos-villes" className="rounded-full px-4 py-2 text-sm font-semibold btn-glow gradient-primary" style={{ color: "#2B1E3F" }}>
      ...
      {/* ─── LocationSection — bloc 8 → #E9F2F4 ─────────────────────────────── */}
      <LocationSection backgroundColor="#E9F2F4" />

      {/* ─── Formulaire — bloc 9 → #F6F1E9 ──────────────────────────────────── */}
      <section className="py-12 md:py-16" style={{ backgroundColor: "#F6F1E9" }}>
        <div className="container">
          <div className="mx-auto max-w-2xl">
            <div className="text-center mb-10">
              <h2 style={{ color: "#2B1E3F" }}>Parlez-nous de votre projet</h2>
              <p className="mt-4 text-lg" style={{ color: "#2B1E3F", opacity: 0.7 }}>
      ...
      <section className="relative overflow-hidden py-16" data-alternate="skip">
        ...
        <div className="container relative z-10 flex flex-col items-center text-center">
          <img
            src={geoffreyPhoto}
            alt="Geoffrey, fondateur de Déclic Digital et Expert Produit Google"
            className="w-32 h-32 rounded-full object-cover border-2 shadow-lg mb-4"
            style={{ borderColor: "rgba(43,30,63,0.3)" }}
            loading="lazy"
          />
          <p className="text-sm font-semibold mb-2" style={{ color: "#2B1E3F" }}>Geoffrey, Expert Produit Google</p>
          <h2 className="mb-4" style={{ color: "#2B1E3F" }}>Prêt à lancer votre site web ?</h2>
          <p className="mb-8 max-w-xl" style={{ color: "#2B1E3F", opacity: 0.7 }}>Demandez un devis gratuit pour la création de votre site web professionnel. Réponse sous 24h.</p>
