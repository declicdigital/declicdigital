...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (data.user) {
      ...
      if (!roleData) { await supabase.auth.signOut(); setError("Accès refusé. Vous n'êtes pas administrateur."); setLoading(false); return; }
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "hsl(263, 36%, 10%)" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.35)" }}>Accès back-office Déclic Digital</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl px-4 pl-9 py-2.5 text-sm text-white placeholder:text-white/20 focus:outline-none transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl px-4 pl-9 pr-10 py-2.5 text-sm text-white placeholder:text-white/20 focus:outline-none transition-colors"
                  style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}
                />
        ...
        <p className="text-center mt-4 text-xs" style={{ color: "rgba(255,255,255,0.2)" }}>
          <Link to="/" className="hover:text-white/50 transition-colors">← Retour au site</Link>
        </p>
      </div>
    </div>
  );
