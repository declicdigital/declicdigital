...
const AuditSeo = () => (
  <PageLayout>
    <Helmet>
      ...
      <meta name="description" content="Recevez un audit SEO complet et gratuit de votre site. Déclic Digital analyse votre visibilité Google et vous propose un plan d'action concret." />
