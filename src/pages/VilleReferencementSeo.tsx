...
const seoFaqsByCity: Record<string, { q: string; a: string }[]> = {
  "asnieres-sur-seine": [
    { q: "Combien de temps faut-il pour voir des résultats SEO ?", a: "Le SEO est un investissement sur le moyen terme. Les premières améliorations de positions sont généralement visibles entre 3 et 6 mois après le début des travaux. Pour des mots-clés compétitifs a Asnières ou dans les Hauts-de-Seine, comptez 6 a 12 mois pour atteindre les premières positions et les maintenir durablement." },
    { q: "Mon site est déja en ligne. Peut-il être optimisé sans refonte ?", a: "Dans la grande majorité des cas, oui. Nous travaillons sur votre site existant : optimisation des balises, amélioration du contenu, correction des erreurs techniques, ajout de données structurées. Une refonte complète n'est nécessaire que si la structure du site est fondamentalement problématique." },
    { q: "Quelle est la différence entre SEO et SEA ?", a: "Le SEA (Google Ads) génère du trafic immédiat mais payant - dès que vous coupez le budget, la visibilité disparaît. Le SEO (référencement naturel) demande plus de temps mais crée une présence durable et gratuite a long terme. Nous recommandons souvent une approche complémentaire : SEA pour l'urgence, SEO pour la rentabilité durable." },
...
const seoFaqsByRegion: Record<string, { q: string; a: string }[]> = {
  paris: [
    { q: "Combien de temps faut-il pour voir des résultats SEO ?", a: "Les premiers résultats apparaissent généralement entre 3 et 6 mois. Le SEO est un investissement a moyen terme qui s'amplifie avec le temps : les positions gagnées restent durables." },
    { q: "Le SEO local est-il vraiment utile pour un indépendant parisien ?", a: "Absolument. 46% des recherches Google ont une intention locale. Quand un client tape plombier Paris 15 ou ostéopathe pres de moi, seuls les sites bien référencés localement apparaissent." },
    { q: "Quelle différence entre SEO et publicité Google Ads ?", a: "Google Ads donne des résultats immédiats mais coute a chaque clic. Le SEO demande plus de temps mais génère du trafic gratuit et durable. L'idéal est souvent de combiner les deux au démarrage." },
  ...
  "hauts-de-seine": [
    { q: "Le SEO fonctionne-t-il pour les entreprises du 92 ?", a: "Oui, et c'est même un avantage. La concurrence SEO dans le 92 est souvent moins féroce qu'a Paris intra-muros, ce qui permet de se positionner plus rapidement sur des mots clés locaux." },
    ...
    { q: "Quel budget prévoir pour le SEO local dans les Hauts-de-Seine ?", a: "Nos forfaits SEO commencent a 50 EUR par mois et incluent l'optimisation technique, le contenu et le suivi. C'est un investissement tres rentable par rapport a la publicité traditionnelle." },
    { q: "Puis-je être visible a la fois dans ma ville et a Paris ?", a: "Oui. Nous travaillons votre référencement pour votre ville du 92 ET Paris grâce a des pages géolocalisées, un maillage interne intelligent et une fiche Google Business bien paramétrée." },
  ],
};
...
const VilleReferencementSeo = () => {
  ...
  const { content } = usePageContent(`seo/${city.slug}`, {
    seoTitle: seo.title,
    seoDescription: seo.description,
    seoH1: seo.h1,
    heroIntro: staticContent?.seoIntro ?? "",
  ...
  // Si custom_html defini dans Supabase, on l'affiche a la place du contenu React
  ...
  return (
    <PageLayout>
      ...
      {customHtml ? (
        <div className="page-custom-html" dangerouslySetInnerHTML={{ __html: customHtml }} />
      ) : (
        <>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2">
                <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  ...
                  <p className="mb-8 text-lg leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.75 }}>
                    {content.heroIntro || `Votre entreprise ${city.description} mérite d'être visible sur Google. Notre agence SEO optimise votre site pour attirer des clients qualifiés.`}
                  </p>
            ...
            <div className="container">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  { stat: "0 EUR", label: "par clic, contrairement a Google Ads" },
                ].map((item, i) => (
          ...
          <section style={{ backgroundColor: "#F6F1E9" }} className="py-12 md:py-16">
            <div className="container">
              <h2 className="text-center mb-4" style={{ color: "#2B1E3F" }}>
                Pourquoi le SEO local est indispensable a {city.nameShort}
              </h2>
              <p className="text-center max-w-2xl mx-auto mb-10" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                {content.seoWhyText || `Le référencement local est essentiel pour les entreprises ${city.description}.`}
              </p>
              <div className="grid gap-6 md:grid-cols-3">
                {[
                  { icon: Eye, title: "Visibilité locale", desc: `Apparaissez en première page Google lorsque vos prospects recherchent vos services a ${city.nameShort}. Le pack local capte 42% des clics.` },
                  ...
                  { icon: TrendingUp, title: "Croissance durable", desc: "Contrairement a la publicité payante, le SEO génère des résultats qui s'amplifient avec le temps." },
                ].map((item, i) => (
                  <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
          ...
          <section style={{ backgroundColor: "#E9F2F4" }} className="py-12 md:py-16">
            <div className="container">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {[
                  { icon: Search, title: "Audit SEO complet", desc: `Analyse approfondie de votre site : technique, contenu, mots clés, concurrence locale a ${city.nameShort}.`, features: ["Analyse technique du site", "Étude de mots clés locaux", "Analyse de la concurrence locale", "Plan d'action priorisé sur 3 mois"] },
                  { icon: FileText, title: "Optimisation on-page", desc: "Chaque page de votre site est retravaillée pour cibler les bons mots clés et offrir la meilleure expérience utilisateur.", features: ["Balises title et meta descriptions", "Optimisation du contenu existant", "Maillage interne stratégique", "Données structurées Schema.org"] },
                  { icon: Target, title: "SEO local renforcé", desc: `Stratégie pour dominer les résultats Google a ${city.nameShort} : fiche Google Business, avis clients, citations locales.`, features: ["Google Business Profile optimisé", "Stratégie de collecte d'avis", "Citations dans les annuaires locaux", "Pages géolocalisées ciblées"] },
          ...
          {(content.seoLocalText || content.localFact) && (
            <section style={{ backgroundColor: "#F6F1E9" }} className="py-12 md:py-16">
              <div className="container">
                <div className="mx-auto max-w-3xl space-y-6">
                  <h2 className="text-center" style={{ color: "#2B1E3F" }}>
                    Apparaître dans Google Maps et les recherches locales a {city.nameShort}
                  </h2>
                  {content.seoLocalText && (
                  ...
                  <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                    Pour apparaître dans le pack local Google Maps, votre fiche Google Business doit être complète et optimisée : photos de qualité, catégorie correcte, description riche en mots clés, horaires a jour et surtout des avis clients positifs.
                  </p>
                  <div className="pt-4">
                    <MapEmbed title="Notre agence a Paris 15e" subtitle={`Nous accompagnons les TPE et indépendants de ${city.nameShort} depuis notre agence parisienne.`} />
                  </div>
                  <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                    Complétez votre stratégie avec un <Link to={`/creation-site-web/${city.slug}`} className="font-semibold hover:underline" style={{ color: "#4361EE" }}>site web professionnel a {city.nameShort}</Link>. Consultez <Link to="/tarifs" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>nos tarifs</Link> ou découvrez <Link to="/realisations" className="font-semibold hover:underline" style={{ color: "#4361EE" }}>nos réalisations</Link>.
                  </p>
                  {content.localFact && (
          ...
          <section style={{ backgroundColor: "#F6F1E9" }} className="py-12 md:py-16">
            <div className="container">
              <h2 className="text-center mb-10" style={{ color: "#2B1E3F" }}>
                Questions fréquentes sur le SEO a {city.nameShort}
              </h2>
              ...
              <div className="mx-auto max-w-3xl text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  {[
                    ...
                    { to: `/creation-site-web/${city.slug}`, label: `Site web a ${city.nameShort}` },
            ...
            <section style={{ backgroundColor: "#F6F1E9" }} className="py-12 md:py-16">
              <div className="container">
                <h2 className="text-center mb-6" style={{ color: "#2B1E3F" }}>
                  Référencement SEO et GEO pres de {city.nameShort}
                </h2>
          ...
          <section data-alternate="skip" className="relative overflow-hidden py-16">
            ...
            <div className="container relative z-10 text-center">
              ...
              <p className="mb-8" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                Découvrez comment attirer plus de clients a {city.nameShort} grâce au référencement Google.
              </p>
