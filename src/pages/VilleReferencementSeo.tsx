      ...
      <section style={{ backgroundColor: "#F6F1E9" }} className="py-12 md:py-16">
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { icon: Eye, title: "Visibilité locale", desc: `Apparaissez en première page Google lorsque vos prospects recherchent vos services a ${city.nameShort} et aux alentours. Le pack local capte 42% des clics.` },
              { icon: Users, title: "Clients qualifiés", desc: "Attirez des visiteurs qui recherchent activement vos services. Le trafic SEO convertit 8x mieux que les réseaux sociaux car l'intention d'achat est déja présente." },
              { icon: TrendingUp, title: "Croissance durable", desc: "Contrairement a la publicité payante, le SEO génère des résultats qui s'amplifient avec le temps. Chaque mois, vos positions se renforcent sans augmenter votre budget." },
            ].map((item, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
        ...
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              { icon: Target, title: "SEO local renforcé", desc: `Stratégie de référencement local pour dominer les résultats Google a ${city.nameShort} : fiche Google Business, avis clients, citations dans les annuaires locaux.`, features: ["Google Business Profile optimisé", "Stratégie de collecte d'avis", "Citations dans les annuaires locaux", "Pages géolocalisées ciblées"] },
          ...
          <div className="container">
            <div className="mx-auto max-w-3xl space-y-6">
              ...
              <p className="leading-relaxed" style={{ color: "#2B1E3F", opacity: 0.7 }}>
                Pour apparaître dans le pack local Google Maps, votre fiche Google Business doit être complète et optimisée : photos de qualité, catégorie correcte, description riche en mots clés, horaires a jour et surtout des avis clients positifs. C'est ce triptyque site + fiche Google + avis qui vous propulse dans les 3 premiers résultats locaux.
              </p>
              <div className="pt-4">
