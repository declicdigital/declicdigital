    ...
    <section style={{ backgroundColor: "#F6F1E9" }} className="py-16 md:py-24">
      <div className="container text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 style={{ color: "#2B1E3F" }}>Plan du site</h1>
        </motion.div>
      </div>
    </section>

    {/* Section 2 — Contenu #E9F2F4 */}
    <section style={{ backgroundColor: "#E9F2F4" }} className="py-12 md:py-16">
      <div className="container">
        <div className="mx-auto max-w-3xl">
            ...
            {links.map((link) => (
              <li key={link.to}>
                <Link
                  ...
                  style={{ backgroundColor: "#F6F1E9", color: "#2B1E3F", boxShadow: "0 4px 24px -4px rgba(43,30,63,0.08)" }}
                >
          ...
          <h2 className="text-2xl font-bold mb-4" style={{ color: "#2B1E3F" }}>Articles de blog</h2>
