      ...
      <header className="border-b border-border bg-card sticky top-0 z-50">
        <div className="container flex h-[4.5rem] md:h-20 items-center justify-between">
          <div className="flex items-center gap-4 -my-2">
            <img src={logoImg} alt="Declic Digital" <img src={logoImg} alt="Declic Digital" className="h-14 md:h-16 w-auto object-contain cursor-pointer" onClick={() => navigate("/admin/clients")} /> onClick={() => navigate("/admin/clients")} />
