          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="flex justify-center">
              {(() => {
                ...
                const heroImg = {"expert-comptable": metierComptable, "plombier": metierPlombier, "electricien": metierElectricien}[trade.slug] || categoryImages[trade.category];
                return heroImg ? (
                  <div className="relative overflow-hidden rounded-2xl shadow-2xl group w-full max-w-md" style={{aspectRatio: "3/4", maxHeight: "480px"}}>
