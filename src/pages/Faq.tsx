...
const faqItems = [
  ...
  { q: "Travaillez-vous uniquement à Paris ?", a: <>Nous intervenons principalement à <Link to="/nos-villes" className="text-primary font-semibold hover:underline">Paris et dans les Hauts-de-Seine (92)</Link> : Boulogne-Billancourt, Issy-les-Moulineaux, Neuilly, Levallois, etc. Nos échanges se font par visio, email et téléphone.</> },
