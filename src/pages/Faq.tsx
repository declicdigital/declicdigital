...
const faqItems: FaqItem[] = [
  ...
  // --- GEO / Visibilité IA ---
  { q: "Qu'est-ce que le GEO (Generative Engine Optimization) ?", aText: "Le GEO regroupe toutes les techniques qui permettent à votre contenu d'être cité et utilisé par les intelligences artificielles comme ChatGPT, Perplexity ou Google AI Overviews lorsqu'elles répondent aux questions de vos futurs clients.", a: <>Le GEO regroupe toutes les techniques qui permettent à votre contenu d'être cité et utilisé par les intelligences artificielles comme ChatGPT, Perplexity ou Google AI Overviews lorsqu'elles répondent aux questions de vos futurs clients. <Link to="/visibilite-ia" className="text-primary font-semibold">Découvrez notre offre GEO</Link>.</> },
  { q: "Quelle est la différence entre le SEO et le GEO ?", aText: "Le SEO vous aide à apparaître dans les résultats Google classiques. Le GEO va plus loin en faisant en sorte que les IA citent directement votre contenu ou votre expertise quand un utilisateur pose une question liée à votre activité.", a: <>Le <Link to="/referencement-seo" className="text-primary font-semibold">SEO</Link> vous aide à apparaître dans les résultats Google classiques. Le <Link to="/visibilite-ia" className="text-primary font-semibold">GEO</Link> va plus loin en faisant en sorte que les IA citent directement votre contenu ou votre expertise quand un utilisateur pose une question liée à votre activité.</> },
  { q: "Le GEO est-il vraiment utile pour un artisan ou un indépendant ?", aText: "Absolument. Quand un client potentiel demande à une IA « quel plombier me recommandes-tu à Lyon » ou « comment choisir un bon graphiste freelance », ce sont les professionnels dont le contenu est bien optimisé qui ressortent en premier.", a: <>Absolument. Quand un client potentiel demande à une IA "quel plombier me recommandes-tu à Lyon" ou "comment choisir un bon graphiste freelance", ce sont les professionnels dont le contenu est bien optimisé qui ressortent en premier. <Link to="/nos-metiers" className="text-primary font-semibold">Voir nos spécialités métier</Link>.</> },
  { q: "Est-ce que le GEO remplace le SEO ?", aText: "Non, les deux se complètent. Si vous avez déjà travaillé votre référencement naturel, le GEO vient renforcer votre visibilité sur un canal de plus en plus utilisé, notamment par les clients qui cherchent des réponses rapides sans parcourir plusieurs sites.", a: <>Non, les deux se complètent. Si vous avez déjà travaillé votre <Link to="/referencement-seo" className="text-primary font-semibold">référencement naturel</Link>, le <Link to="/visibilite-ia" className="text-primary font-semibold">GEO</Link> vient renforcer votre visibilité sur un canal de plus en plus utilisé, notamment par les clients qui cherchent des réponses rapides sans parcourir plusieurs sites.</> },
  { q: "Le GEO est-il accessible sans gros budget ?", aText: "Oui, c'est même là où les indépendants et artisans ont une vraie carte à jouer. Contrairement au SEO où les grandes entreprises dominent avec des budgets importants, le GEO valorise avant tout la clarté, l'expertise métier et la précision de votre contenu.", a: <>Oui, c'est même là où les indépendants et artisans ont une vraie carte à jouer. Contrairement au SEO où les grandes entreprises dominent avec des budgets importants, le GEO valorise avant tout la clarté, l'expertise métier et la précision de votre contenu. <Link to="/tarifs" className="text-primary font-semibold">Voir nos tarifs</Link>.</> },
  { q: "GEO : par quoi commencer concrètement ?", aText: "La première étape consiste à rédiger des contenus qui répondent clairement aux questions que posent vos clients : une FAQ sur votre site, des descriptions précises de vos services, des conseils pratiques liés à votre métier. Simple, structuré et utile.", a: <>La première étape consiste à rédiger des contenus qui répondent clairement aux questions que posent vos clients : une FAQ sur votre site, des descriptions précises de vos services, des conseils pratiques liés à votre métier. <Link to="/blog" className="text-primary font-semibold">Consultez notre blog</Link> pour des exemples concrets.</> },
  { q: "Combien de temps pour voir des résultats en GEO ?", aText: "Les premières citations dans les réponses IA peuvent apparaître en quelques semaines avec un contenu bien travaillé. Comme pour le référencement naturel, les résultats s'installent dans la durée, mais les fondations se posent rapidement.", a: <>Les premières citations dans les réponses IA peuvent apparaître en quelques semaines avec un contenu bien travaillé. Comme pour le <Link to="/referencement-seo" className="text-primary font-semibold">référencement naturel</Link>, les résultats s'installent dans la durée, mais les fondations se posent rapidement.</> },
  { q: "Faut-il refaire tout son site web pour le GEO ?", aText: "Non. On commence par optimiser ce qui existe déjà : améliorer les textes de vos pages, ajouter une FAQ, préciser vos zones d'intervention et vos spécialités. Une refonte complète n'est pas nécessaire pour démarrer.", a: <>Non. On commence par optimiser ce qui existe déjà : améliorer les textes de vos pages, ajouter une FAQ, préciser vos <Link to="/nos-villes" className="text-primary font-semibold">zones d'intervention</Link> et vos spécialités. Une refonte complète n'est pas nécessaire pour démarrer.</> },
  { q: "Comment savoir si une IA cite mon contenu ?", aText: "Vous pouvez tester manuellement en posant des questions liées à votre activité sur ChatGPT, Perplexity ou Google AI Overviews et observer si votre site ou votre nom apparaît. Des outils de monitoring plus avancés existent aussi pour un suivi régulier.", a: <>Vous pouvez tester manuellement en posant des questions liées à votre activité sur ChatGPT, Perplexity ou Google AI Overviews et observer si votre site ou votre nom apparaît. <Link to="/contact" className="text-primary font-semibold">Contactez-nous</Link> pour un audit de votre visibilité IA.</> },
  { q: "Le GEO est-il utile même si je travaille uniquement en local ?", aText: "Encore plus. Une IA interrogée sur un besoin local (un électricien, un photographe, un coach) va chercher des sources précises et géolocalisées. Mentionner clairement vos zones d'intervention et votre ville dans vos contenus est un levier GEO très efficace pour les professionnels de proximité.", a: <>Encore plus. Une IA interrogée sur un besoin local va chercher des sources précises et géolocalisées. Mentionner clairement vos <Link to="/nos-villes" className="text-primary font-semibold">zones d'intervention</Link> et votre ville dans vos contenus est un levier GEO très efficace pour les professionnels de proximité.</> },
