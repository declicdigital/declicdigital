...
const faqItems = [
  ...
  { q: "Pourquoi faire du référencement SEO ?", a: <>Le <Link to="/referencement-seo" className="text-primary font-semibold hover:underline">SEO</Link> permet d'attirer des visiteurs qualifiés gratuitement depuis Google. C'est un investissement durable qui génère des clients sur le long terme. Consultez <Link to="/tarifs" className="text-primary font-semibold hover:underline">nos tarifs SEO</Link>.</> },
  ...
  { q: "Quelle est la différence entre SEO et SEA ?", a: <>Le <Link to="/referencement-seo" className="text-primary font-semibold hover:underline">SEO</Link> est le référencement naturel (gratuit mais long terme). Le SEA correspond aux publicités payantes sur Google (résultats immédiats mais coûteux).</> },
  ...
  { q: "Proposez-vous la maintenance du site ?", a: <>Oui, nous proposons des forfaits de maintenance incluant les mises à jour, la sécurité et le suivi des performances. Consultez <Link to="/tarifs" className="text-primary font-semibold hover:underline">nos tarifs</Link>.</> },
  { q: "Travaillez-vous uniquement à Paris ?", a: <>Nous intervenons principalement à <Link to="/nos-villes" className="text-primary font-semibold hover:underline">Paris et dans les Hauts-de-Seine (92)</Link>. Nous pouvons aussi accompagner des entreprises en Île-de-France. Nos échanges se font par visioconférence, email et téléphone.</> },
  { q: "Quelles technologies utilisez-vous ?", a: <>Nous utilisons WordPress, Shopify, Lovable, Base44 et des technologies sur mesure selon les besoins du projet. Découvrez <Link to="/realisations" className="text-primary font-semibold hover:underline">nos réalisations</Link>.</> },
  { q: "Le site sera-t-il adapté au mobile ?", a: <>Tous nos <Link to="/creation-site-web" className="text-primary font-semibold hover:underline">sites web</Link> sont responsive : ils s'adaptent parfaitement aux smartphones, tablettes et ordinateurs de bureau.</> },
  ...
  { q: "Faut-il un nom de domaine ?", a: <>Oui, un nom de domaine est nécessaire. Nous pouvons vous accompagner dans le choix et l'achat de votre nom de domaine. <Link to="/contact" className="text-primary font-semibold hover:underline">Contactez-nous</Link>.</> },
...
const Faq = () => (
  <PageLayout>
    <Helmet>
      ...
      <meta name="description" content="Toutes les réponses à vos questions sur la création de site web et le référencement SEO pour les TPE et artisans. Délais, tarifs, méthodes et conseils pratiques." />
