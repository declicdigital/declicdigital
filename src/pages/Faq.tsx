...
const faqItems: FaqItem[] = [
  ...
  { q: "Mon site actuel peut-il être amélioré ?", aText: "Dans la plupart des cas, oui. Notre audit gratuit analyse votre site et identifie les axes d'amélioration prioritaires.", a: <>Dans la plupart des cas, oui. Notre <Link to="/audit-seo-gratuit" className="text-primary font-semibold hover:underline">audit gratuit</Link> analyse votre site et identifie les axes d'amélioration prioritaires.</> },
  ...
  { q: "Mon site ne génère aucun appel, pourquoi ?", aText: "Les raisons les plus fréquentes : absence de SEO, site trop lent, pas de bouton d'appel visible, contenu trop vague. Notre audit gratuit identifie précisément ce qui bloque.", a: <>Les raisons les plus fréquentes : absence de SEO, site trop lent, pas de bouton d'appel visible, contenu trop vague. Notre <Link to="/audit-seo-gratuit" className="text-primary font-semibold hover:underline">audit gratuit</Link> identifie précisément ce qui bloque.</> },
