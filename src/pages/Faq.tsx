...
const faqItems: FaqItem[] = [
  ...
  { q: "Faut-il un nom de domaine ?", aText: "Oui, un nom de domaine est nécessaire pour votre identité en ligne. Nous pouvons vous accompagner dans le choix et l'achat de votre nom de domaine.", a: <>Oui, un nom de domaine est nécessaire pour votre identité en ligne. Nous pouvons vous accompagner dans le choix et l'achat de votre nom de domaine. <Link to="/contact" className="text-primary font-semibold hover:underline">Contactez-nous</Link>.</> },
  ...
  { q: "Quels sont vos délais de réponse ?", aText: "Nous répondons généralement sous 24 à 48h. Pour les demandes d'audit SEO, vous recevez un retour détaillé sous 48h.", a: <>Nous répondons généralement sous 24 à 48h. Pour les demandes d'audit SEO, vous recevez un retour détaillé sous 48h. <Link to="/contact" className="text-primary font-semibold hover:underline">Contactez-nous</Link>.</> },
