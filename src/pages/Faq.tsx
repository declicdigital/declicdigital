...
const faqItems = [
  { q: "Combien coûte un site web ?", a: "Nos tarifs sont pensés pour les PME. Une landing page commence à 50€/mois + 200€ la première mensualité. Un site vitrine à 50€/mois + 590€, et un site vitrine + SEO à 75€/mois + 990€. Engagement de 6 mois renouvelable. Contactez-nous pour un devis personnalisé." },
  { q: "Combien de temps pour créer un site ?", a: "Une landing page est livrée en 1 à 2 semaines. Un site vitrine complet prend en moyenne 2 à 4 semaines selon la complexité et les fonctionnalités." },
